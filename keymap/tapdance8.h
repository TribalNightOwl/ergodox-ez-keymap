...
void dance8_finished (qk_tap_dance_state_t *state, void *user_data) {
  ...
  switch (dance8_state.state) {
    case SINGLE_TAP:  register_code(KC_RCTL); register_code(KC_B); break;
    case SINGLE_HOLD: register_code(KC_RCTL); register_code(KC_B); unregister_code(KC_RCTL); unregister_code(KC_B); register_code(KC_LBRACKET); break;
    case DOUBLE_TAP:  register_code(KC_LALT); register_code(KC_W); break;
    case DOUBLE_HOLD: register_code(KC_RCTL); register_code(KC_B); unregister_code(KC_RCTL); unregister_code(KC_B); register_code(KC_RBRACKET); break;
...
void dance8_reset (qk_tap_dance_state_t *state, void *user_data) {
  switch (dance8_state.state) {
    case SINGLE_TAP:  unregister_code(KC_RCTL); unregister_code(KC_B); break;
    case SINGLE_HOLD: unregister_code(KC_LBRACKET); break;
    case DOUBLE_TAP:  unregister_code(KC_LALT); unregister_code(KC_W); break;
